...
/**
 * r_insert_node - node_value addition in a AVL.
 * @tree: root_node of the AVL tree struct.
 * @parent: parent node of struct AVL.
 * @new: left or right insertion.
 * @nval: insertion value of the AVL.
 * Return: new root after addition otherwise NULL
 */
...
/**
 * avl_insert - inputs a value into an AVL tree.
 * @tree: root_node of the AVL tree to insert into.
 * @value: value to store in the node to be inputs
 * Return: input node, or NULL if fails.
 */
